...
exports.validateSchema = exports.getSchema = exports.getSchemaForEndpoint = void 0;
...
const getSchemaForEndpoint = (endpointName) => {
    ...
    for (const response of Object.keys(spec.paths[endpointName].get.responses)) {
        // success 200
        if (response === '200') {
            const referenceOrValue = spec.paths[endpointName].get.responses['200'].content['application/json'].schema;
